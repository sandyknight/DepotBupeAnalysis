#' Plot LAB treatment rates
#' @description Creates a column plot of LAB treatment rates as percentages
#' @param dt data.table containing rate data
#' @param fill_var Optional character name of variable to use for fill colors
#' @return ggplot object
#' @details Uses afcharts styling and formats y-axis as percentages
#' @export
